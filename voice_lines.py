# file contains the voice lines of each character
# sourced from https://genshin-impact.fandom.com/wiki/Category:Character_Voice-Overs
...
kujou_sara_lines = [
  ...
  [
    ...
    "Shikanoin and I may be colleagues, but I have few positive words to say about him. He seems preoccupied with his personal schemes while official duties take second place. The only reason I have not sought to bring him into line so far is that his investigations deliver results...*sigh* He is such a headache."
...
raiden_lines = [
  ...
  [
    ...
    "That's the name the Anemo Archon takes these days, is it? Truth be told, from the very first moment I met him, I could somehow sense that we were not going to get along. Also, he sure can drink a lot.",
  ...
  [
    ...
    "At the intermediate stage of my journey, or Chuden, the art of the sword focuses on the study of various stances and transitions. The art of the polearm — slashes and backslashes.",
...
kokomi_lines = [
  ...
  #interesting
  [
    "I simply love Watatsumi Coral Pearls... They're not just a source of income for Watatsumi Island, but a gift from the sea itself."
  ],
  #about-others
  [
